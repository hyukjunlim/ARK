...
@registry.register_model("equiformer_v2_teacher")
class EquiformerV2Teacher(nn.Module, GraphModelMixin):
    """
    ...
    def forward(self, data: Batch) -> dict[str, torch.Tensor]:
        ...
        return {"node_embedding": x, "graph": graph, "embs_teacher": x.embedding, "edge_index": graph.edge_index}
