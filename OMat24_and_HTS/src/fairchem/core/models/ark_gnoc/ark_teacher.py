...
@registry.register_model("ark_gnoc_teacher")
class ARKTeacher(nn.Module, GraphModelMixin):
    """
    Arguments
    ---------
    num_spherical: int
...
@registry.register_model("ark_gnoc_teacher_backbone")
class ARKTeacherBackbone(ARKTeacher, BackboneInterface):
    @conditional_grad(torch.enable_grad())
...
@registry.register_model("ark_gnoc_teacher_energy_and_grad_force_head")
class ARKTeacherEnergyAndGradForceHead(nn.Module, HeadInterface):
    def __init__(
        self,
...
@registry.register_model("ark_gnoc_teacher_force_head")
class ARKTeacherForceHead(nn.Module, HeadInterface):
    def __init__(
        self,
        backbone,
        num_global_out_layers: int,
